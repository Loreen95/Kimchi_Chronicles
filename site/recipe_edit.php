...
if (is_post_request()) {
    ...
    $amounts = !empty($_POST['amounts']) ? $_POST['amounts'] : $amounts['amount'];
    $steps = !empty($_POST['steps']) ? $_POST['steps'] : $steps['steps'];
...
<div class="formcontainer">
    ...
    <form method="post">
        <div class="input-icons" id="image">
            ...
            <input class="input-field" type="text" id="title" name="title" placeholder="Titel" value="<?php echo $recipe['title'] ?>">
        </div>


        <div class="input-icons">
            <i class="fa-solid fa-book icon"></i>
            <input class="input-field" type="text" id="duration" name="duration" placeholder="Bereidingstijd" value="<?php echo $recipe['duration'] ?>">
        </div>
